...
If the user wants only specific files, call `list_downloadable_files` and show the exact local paths for the available Markdown, DOCX, and PDF files. Do not force a complete export for a single resume or cover letter.
