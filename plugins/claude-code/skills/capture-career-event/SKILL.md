...
5. Show the exact proposed accomplishment and evidence links. Obtain explicit confirmation before routing it through `$update-accomplishments`; use `evidence-reviewer` to verify traceability.
